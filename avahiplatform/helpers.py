    ...
    def model_invoke(self, prompt, model_name=None, max_retries=15, initial_delay=2):
        ...
        while retries < max_retries:
            try:
                ...
                user_friendly_error = self.get_user_friendly_error(e)
    ...
    def read_s3_file(self, s3_file_path):
        ...
        try:
            ...
            if 'application/pdf' in content_type:
                text = self.helper.read_pdf_from_stream(BytesIO(body))
            elif 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' in content_type:
                text = self.helper.read_docx(BytesIO(body))
            else:
            ...
            user_friendly_error = self.helpers.get_user_friendly_error(e)
            logger.error(user_friendly_error)
